...
<input type="text" name="sponsor" value="${film.sponsor}"
class="form-control"/>
</div>
<div class="form-group">
<label class="control-label"> Date de Sortie :</label>
<fmt:formatDate pattern="yyyy-MM-dd" value="${film.dateSortie}" var="formatDate" />
...
<br/>
<br/>
<a href="listeFilms">Liste des Films</a>
</div>
</body>
</html>